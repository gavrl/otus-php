...
namespace Gavrl\SocketChat\SocketChat;

use Gavrl\SocketChat\Exception\{ReadFromStdinException, WriteToStdoutException};
use Gavrl\SocketChat\Service\SocketService;
use Gavrl\SocketChat\Utils\ConfigInterface;
use Socket;
...
class Client
{
    ...
    {
        $this->writeToStdout("Enter message or 'q' to exit");
        do {
